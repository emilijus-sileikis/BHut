                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade border p-3 show active" id="main-tab-pane" role="tabpanel" aria-labelledby="main-tab" tabindex="0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ $product->name }}" class="form-control" maxlength="50" required>
                                </div>
                                <div class="mb-3">
                                    <label for="slug">Product Slug</label>
                                    <input type="text" id="slug" name="slug" value="{{ $product->slug }}" class="form-control" maxlength="100" required>
                                </div>
                                <div class="mb-3">
                                    <label for="short_descr">Short Description (200 Symbols)</label>
                                    <textarea id="short_descr" name="small_description" class="form-control" rows="4" maxlength="200" required>{{ $product->small_description }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="descr">Description</label>
                                    <textarea id="descr" name="description" class="form-control" rows="4" maxlength="500" required>{{ $product->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade border p-3" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" id="meta" name="meta_title" value="{{ $product->meta_title }}" class="form-control" maxlength="100" required>
                                </div>
                                <div class="mb-3">
                                    <label for="meta_descr">Meta Description</label>
                                    <textarea id="meta_descr" name="meta_description" class="form-control" rows="4" maxlength="500" required>{{ $product->meta_description }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="meta_key">Meta Keyword</label>
                                    <textarea id="meta_key" name="meta_keyword" class="form-control" rows="4" maxlength="100" required>{{ $product->meta_keyword }}</textarea>
                                </div>
                            </div>
