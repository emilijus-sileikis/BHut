                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="slug">Slug</label>
                                    <input type="text" id="slug" name="slug" value="{{ $item->slug }}" class="form-control" required>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="descr">Description</label>
                                    <textarea id="descr" name="description" class="form-control" rows="3" required>{{ $item->description }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Image</label>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="meta_t">Meta Title</label>
                                    <input type="text" id="meta_t" name="meta_title" value="{{ $item->meta_title }}" class="form-control" required>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="meta_k">Meta Keyword</label>
                                    <textarea id="meta_k" name="meta_keyword" class="form-control" rows="3" required>{{ $item->meta_keyword }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="meta_d">Meta Description</label>
                                    <textarea id="meta_d" name="meta_description" class="form-control" rows="3" required>{{ $item->meta_description }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
